...
trashImg10.src = './Images/brown-boot-drunk2.png';
...
trashImg12.src = './Images/license-plate-yellow-drunk2.png';
...
if (beerScore === 2){
type = trashTypesDrunkLevelOne[Math.floor(Math.random() * trashTypesDrunkLevelOne.length)];
}

if (beerScore === 4){
type = trashTypesDrunkLevelTwo[Math.floor(Math.random() * trashTypesDrunkLevelTwo.length)];
}
...
class ObstacleTrash {
	...
	draw() {
        this.ctx.drawImage(type, this.x, this.y, this.width, this.height);
	}
